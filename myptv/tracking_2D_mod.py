...
class track_2D(tracker_four_frames):
    ...
    camera. This class uses the four frame algorithm tracker.
...
class track_2D_multiframe(tracker_multiframe):
    '''
    A class used to perform particle tracking in 2D using images from a single
    camera. This class uses the multiframe algorithm tracker.
...
if __name__=='__main__':
    ...
    t2d = track_2D_multiframe(cam, fname, z,  max_dt, Ns, 
